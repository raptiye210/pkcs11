...
const dummySignature = Buffer.from("308006092a864886f70d010702a080", "hex");

const signedPdf = signPdf.sign(pdfWithPlaceholder, dummySignature, {
  // certificate: fs.readFileSync("certificate.pem"), // Opsiyonel
});

fs.writeFileSync("C:\\proje\\pkcs11\\src\\a-signed.pdf", signedPdf);
console.log("PDF SAHTE imza ile imzalandı ve kaydedildi: a-signed.pdf");
console.log("---------------------------");
